...
//		String xsdPath = XMLSchemaUtil.class.getClassLoader().getResource("templates/SDA.xsd").getPath();
//		String xmlPath = XMLSchemaUtil.class.getClassLoader().getResource("templates/template1.ftl").getPath();
//		System.out.println(validateXMLSchema(xsdPath, xmlPath));
		...
		String xmlFileName = XMLSchemaUtil.class.getClassLoader().getResource("templates/template15.ftl").getPath();

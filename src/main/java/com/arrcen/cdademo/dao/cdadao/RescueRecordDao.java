...
public interface RescueRecordDao extends JpaRepository<RescueRecord,String> {

    @Query(value = "select * from PUB13_抢救记录 where 住院号 = ?1",nativeQuery = true)
    RescueRecord findBy住院号(String 住院号);

...
public interface SurgeryInformConsentDao extends JpaRepository<SurgeryInformConsent,String> {

    @Query(value = "select * from PUB09_手术同意书 where 门急诊号 = ?1",nativeQuery = true)
    SurgeryInformConsent findBy门急诊号(String 门急诊号);

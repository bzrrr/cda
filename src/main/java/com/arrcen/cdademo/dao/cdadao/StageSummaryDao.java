...
public interface StageSummaryDao extends JpaRepository<StageSummary,String> {

    @Query(value = "select * from PUB13_阶段小结 where 住院号 = ?1",nativeQuery = true)
    StageSummary findBy住院号(String 住院号);

...
public interface ConsultationRecordDao extends JpaRepository<ConsultationRecord,String> {

    @Query(value = "select * from PUB13_会诊记录 where 住院号 = ?1",nativeQuery = true)
    ConsultationRecord findBy住院号(String 住院号);

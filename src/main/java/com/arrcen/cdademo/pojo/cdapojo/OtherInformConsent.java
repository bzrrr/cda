 ...
 */
@Entity
@Table(name = "PUB09_其他知情同意书")
public class OtherInformConsent implements Serializable {

    private static final long serialVersionUID = -5187460199886924129L;
    @Id
    private String 系统序号;
    private String 门急诊号;
    private String 住院号;
    private String 知情同意书名称;
    ...
    public String get知情同意书名称() {
        return 知情同意书名称;
    }

    public void set知情同意书名称(String 知情同意书名称) {
        this.知情同意书名称 = 知情同意书名称;
    }
    ...
    public String get知情同意内容() {
        return 知情同意内容;
    }

    public void set知情同意内容(String 知情同意内容) {
        this.知情同意内容 = 知情同意内容;
    }

...
public class InpatientMedicalRecordHomepage implements Serializable {
    ...
    private String 出院病房;
    private Long 实际住院天数;
    private String 门急诊诊断名称;
    private String 门急诊诊断疾病编码;
    @Transient
    @JsonIgnore
    private String 门急诊诊断疾病名称;
    private String 出院诊断_主要诊断名称;
    private String 出院诊断_主要诊断疾病编码;
    @Transient
    @JsonIgnore
    private String 出院诊断_主要诊断疾病名称;
    private String 出院诊断_主要诊断入院病情代码;
    @Transient
    @JsonIgnore
    private String 出院诊断_主要诊断入院病情;
    private String 出院诊断_其他诊断名称;
    private String 出院诊断_其他诊断疾病编码;
    @Transient
    @JsonIgnore
    private String 出院诊断_其他诊断疾病名称;
    private String 出院诊断_其他诊断入院病情代码;
    @Transient
    @JsonIgnore
    private String 出院诊断_其他诊断入院病情;
    private String 损伤中毒的外部原因;
    private String 损伤中毒的外部原因疾病编码;
    @Transient
    @JsonIgnore
    private String 损伤中毒的外部原因疾病名称;
    private String 病理诊断名称;
    private String 病理诊断疾病编码;
    @Transient
    @JsonIgnore
    private String 病理诊断疾病名称;
    private String 病理号;
    ...
    public String get门急诊诊断名称() {
        return 门急诊诊断名称;
    }

    public void set门急诊诊断名称(String 门急诊诊断名称) {
        this.门急诊诊断名称 = 门急诊诊断名称;
    }

    public String get门急诊诊断疾病编码() {
        return 门急诊诊断疾病编码;
    }

    public void set门急诊诊断疾病编码(String 门急诊诊断疾病编码) {
        this.门急诊诊断疾病编码 = 门急诊诊断疾病编码;
    }

    public String get门急诊诊断疾病名称() {
        return 门急诊诊断疾病名称;
    }

    public void set门急诊诊断疾病名称(String 门急诊诊断疾病名称) {
        this.门急诊诊断疾病名称 = 门急诊诊断疾病名称;
    }

    public String get出院诊断_主要诊断名称() {
        return 出院诊断_主要诊断名称;
    }

    public void set出院诊断_主要诊断名称(String 出院诊断_主要诊断名称) {
        this.出院诊断_主要诊断名称 = 出院诊断_主要诊断名称;
    }

    public String get出院诊断_主要诊断疾病编码() {
        return 出院诊断_主要诊断疾病编码;
    }

    public void set出院诊断_主要诊断疾病编码(String 出院诊断_主要诊断疾病编码) {
        this.出院诊断_主要诊断疾病编码 = 出院诊断_主要诊断疾病编码;
    }

    public String get出院诊断_主要诊断疾病名称() {
        return 出院诊断_主要诊断疾病名称;
    }

    public void set出院诊断_主要诊断疾病名称(String 出院诊断_主要诊断疾病名称) {
        this.出院诊断_主要诊断疾病名称 = 出院诊断_主要诊断疾病名称;
    }

    public String get出院诊断_主要诊断入院病情代码() {
        return 出院诊断_主要诊断入院病情代码;
    }

    public void set出院诊断_主要诊断入院病情代码(String 出院诊断_主要诊断入院病情代码) {
        this.出院诊断_主要诊断入院病情代码 = 出院诊断_主要诊断入院病情代码;
    }

    public String get出院诊断_主要诊断入院病情() {
        return 出院诊断_主要诊断入院病情;
    }

    public void set出院诊断_主要诊断入院病情(String 出院诊断_主要诊断入院病情) {
        this.出院诊断_主要诊断入院病情 = 出院诊断_主要诊断入院病情;
    }

    public String get出院诊断_其他诊断名称() {
        return 出院诊断_其他诊断名称;
    }

    public void set出院诊断_其他诊断名称(String 出院诊断_其他诊断名称) {
        this.出院诊断_其他诊断名称 = 出院诊断_其他诊断名称;
    }

    public String get出院诊断_其他诊断疾病编码() {
        return 出院诊断_其他诊断疾病编码;
    }

    public void set出院诊断_其他诊断疾病编码(String 出院诊断_其他诊断疾病编码) {
        this.出院诊断_其他诊断疾病编码 = 出院诊断_其他诊断疾病编码;
    }

    public String get出院诊断_其他诊断疾病名称() {
        return 出院诊断_其他诊断疾病名称;
    }

    public void set出院诊断_其他诊断疾病名称(String 出院诊断_其他诊断疾病名称) {
        this.出院诊断_其他诊断疾病名称 = 出院诊断_其他诊断疾病名称;
    }

    public String get出院诊断_其他诊断入院病情代码() {
        return 出院诊断_其他诊断入院病情代码;
    }

    public void set出院诊断_其他诊断入院病情代码(String 出院诊断_其他诊断入院病情代码) {
        this.出院诊断_其他诊断入院病情代码 = 出院诊断_其他诊断入院病情代码;
    }

    public String get出院诊断_其他诊断入院病情() {
        return 出院诊断_其他诊断入院病情;
    }

    public void set出院诊断_其他诊断入院病情(String 出院诊断_其他诊断入院病情) {
        this.出院诊断_其他诊断入院病情 = 出院诊断_其他诊断入院病情;
    }
    ...
    public String get损伤中毒的外部原因疾病名称() {
        return 损伤中毒的外部原因疾病名称;
    }

    public void set损伤中毒的外部原因疾病名称(String 损伤中毒的外部原因疾病名称) {
        this.损伤中毒的外部原因疾病名称 = 损伤中毒的外部原因疾病名称;
    }
    ...
    public String get病理诊断疾病名称() {
        return 病理诊断疾病名称;
    }

    public void set病理诊断疾病名称(String 病理诊断疾病名称) {
        this.病理诊断疾病名称 = 病理诊断疾病名称;
    }

                        ...
                        <organizer classCode="BATTERY" moodCode="EVN">
                            ...
                            <component>
                                <observation classCode="OBS" moodCode="EVN">
                                    ...
                                    <value xsi:type="CD" code="" displayName="" codeSystem="2.16.156.10011.2.3.1.85"
                            ...
                            <component>
                                <observation classCode="OBS" moodCode="EVN">
                                    <code code="DE04.50.010.00" codeSystem="2.16.156.10011.2.2.1"
                                          codeSystemName="卫生信息数据元目录" displayName=""/>
                                    <value xsi:type="CD" code="" displayName="" codeSystem="2.16.156.10011.2.3.1.250"
                ...
                <section>
                    ...
                    <entry>
                        <procedure classCode="PROC" moodCode="EVN">
                            ...
                            <!-- 手术目标部位 -->
                            <targetSiteCode code="" displayName="" codeSystem="2.16.156.10011.2.3.1.266"
